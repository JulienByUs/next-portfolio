                ...
                <section className=''>
                    ...
                    <div className="relative isolate">
                        <div className="overflow-hidden">
                            <div
                                className="hero-card-el mx-auto max-w-7xl px-6 pb-20 md:pb-32 pt-20 md:pt-36 lg:px-8 lg:pt-32">
                                <div
                                    ...
                                    <div className="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                                        ...
                                        <p className="relative mt-6 text-base md:text-lg leading-6 md:leading-8 text-gray-600 sm:max-w-md lg:max-w-none">
                                            Abonnez-vous à ma newsletter et recevez du contenu exclusif directement dans
                                            votre boîte mail ! Ne manquez pas cette occasion - inscrivez-vous dès
                                            maintenant !
                                        </p>
                    ...
                    <div className='mx-auto mt-20 max-w-7xl px-6 sm:mt-20 lg:px-8'>
                        <div className="max-w-7xl px-6 lg:px-8 pb-10 lg:pb-12">
                            <h2 className="text-4xl font-bold tracking-tight text-[#0E0B3D] sm:text-6xl">Articles
                                récents</h2>
                        </div>
                        <div
